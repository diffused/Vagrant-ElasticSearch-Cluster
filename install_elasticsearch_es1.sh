...
sudo sh -c 'echo "network.publish_host: 192.168.50.20" >> /etc/elasticsearch/elasticsearch.yml'
sudo sh -c 'echo "discovery.zen.minimum_master_nodes: 2" >> /etc/elasticsearch/elasticsearch.yml'
